...
const decodePackProvingProcess = (buffer) => {
    return borsh_1.deserializeUnchecked(exports.PACK_PROVING_PROCESS_SCHEMA, ProvingProcess, buffer);
};
exports.decodePackProvingProcess = decodePackProvingProcess;
const getProvingProcessByPackSetAndWallet = ({ connection, packSetKey, walletKey, }) => web3_1.getProgramAccounts(connection, __2.PACK_CREATE_ID.toString(), {
    ...
    filters: [
        ...
        },
        {
            memcmp: {
                offset: 1,
                bytes: __2.toPublicKey(walletKey).toBase58(),
            },
        },
        {
            memcmp: {
                offset: 1 + 32 + 1 + 32,
                bytes: __2.toPublicKey(packSetKey).toBase58(),
            },
        },
    ],
});
...
const getProvingProcessByPubkey = async (connection, pubkey) => {
    ...
    return {
        pubkey,
        account: info,
        info: exports.decodePackProvingProcess(Buffer.from(info === null || info === void 0 ? void 0 : info.data)),
    };
};
