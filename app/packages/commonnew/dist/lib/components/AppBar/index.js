...
require("./style.css");
const AppBar = (props) => {
    const { connected } = (0, contexts_1.useWallet)();
    const TopBar = (react_1.default.createElement("div", { className: "App-Bar-right" },
        props.left,
        connected ? (react_1.default.createElement(CurrentUserBadge_1.CurrentUserBadge, null)) : (react_1.default.createElement(ConnectButton_1.ConnectButton, { type: "text", size: "large", allowWalletChange: true, style: { color: '#2abdd2' } })),
