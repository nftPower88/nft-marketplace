...
const ExplorerLink = (props) => {
    ...
    let { endpoint } = (0, contexts_1.useConnectionConfig)();
    ...
    const displayAddress = short || props.length
        ? (0, utils_1.shortenAddress)(address, (_b = props.length) !== null && _b !== void 0 ? _b : 9)
        : address;
    return (react_1.default.createElement("a", { href: (0, explorer_1.getExplorerUrl)(address, endpoint, type, props.connection), 
