...
const Settings = ({ additionalSettings, }) => {
    const { connected, disconnect, publicKey } = (0, contexts_1.useWallet)();
    const { endpoint, setEndpoint } = (0, contexts_1.useConnectionConfig)();
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { style: { display: 'grid' } },
            "Network:",
            ' ',
            react_1.default.createElement(antd_1.Select, { onSelect: setEndpoint, value: endpoint, style: { marginBottom: 20 } }, contexts_1.ENDPOINTS.map(({ name, endpoint }) => (react_1.default.createElement(antd_1.Select.Option, { value: endpoint, key: endpoint }, name)))),
