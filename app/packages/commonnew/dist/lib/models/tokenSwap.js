...
exports.TokenSwapLayoutLegacyV0 = BufferLayout.struct([
    ...
    (0, layout_1.publicKey)('tokenAccountA'),
    (0, layout_1.publicKey)('tokenAccountB'),
    (0, layout_1.publicKey)('tokenPool'),
    (0, layout_1.uint64)('feesNumerator'),
    (0, layout_1.uint64)('feesDenominator'),
]);
exports.TokenSwapLayoutV1 = BufferLayout.struct([
    ...
    (0, layout_1.publicKey)('tokenAccountB'),
    (0, layout_1.publicKey)('tokenPool'),
    (0, layout_1.publicKey)('mintA'),
    (0, layout_1.publicKey)('mintB'),
    (0, layout_1.publicKey)('feeAccount'),
    BufferLayout.u8('curveType'),
    (0, layout_1.uint64)('tradeFeeNumerator'),
    (0, layout_1.uint64)('tradeFeeDenominator'),
    (0, layout_1.uint64)('ownerTradeFeeNumerator'),
    (0, layout_1.uint64)('ownerTradeFeeDenominator'),
    (0, layout_1.uint64)('ownerWithdrawFeeNumerator'),
    (0, layout_1.uint64)('ownerWithdrawFeeDenominator'),
