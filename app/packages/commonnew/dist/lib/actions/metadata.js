...
const decodeMetadata = async (buffer) => {
    const metadata = (0, borsh_1.deserializeBorsh)(exports.METADATA_SCHEMA, Metadata, buffer);
...
const decodeEdition = (buffer) => {
    return (0, borsh_1.deserializeBorsh)(exports.METADATA_SCHEMA, Edition, buffer);
};
exports.decodeEdition = decodeEdition;
const decodeMasterEdition = (buffer) => {
    return (0, borsh_1.deserializeBorsh)(exports.METADATA_SCHEMA, MasterEdition, buffer);
};
exports.decodeMasterEdition = decodeMasterEdition;
const decodeNameSymbolTuple = (buffer) => {
    return (0, borsh_1.deserializeBorsh)(exports.METADATA_SCHEMA, NameSymbolTuple, buffer);
};
...
async function transferUpdateAuthority(account, currentUpdateAuthority, newUpdateAuthority, instructions) {
    const metadataProgramId = (0, ids_1.programIds)().metadata;
    const data = Buffer.from((0, borsh_2.serialize)(exports.METADATA_SCHEMA, new TransferUpdateAuthorityArgs()));
    const keys = [
        {
            pubkey: account,
            isSigner: false,
...
async function updateMetadata(symbol, name, uri, newNonUniqueSpecificUpdateAuthority, mintKey, updateAuthority, instructions, metadataAccount, nameSymbolAccount) {
    ...
    const data = Buffer.from((0, borsh_2.serialize)(exports.METADATA_SCHEMA, value));
    const keys = [
        {
...
async function createMasterEdition(name, symbol, maxSupply, mintKey, masterMintKey, updateAuthorityKey, mintAuthorityKey, instructions, payer) {
    ...
    const keys = [
        ...
        {
            pubkey: (0, ids_1.programIds)().token,
            isSigner: false,
            isWritable: false,
        },
        {
...
async function getNameSymbol(metadata) {
    const PROGRAM_IDS = (0, ids_1.programIds)();
