...
const decodeVault = (buffer) => {
    return (0, borsh_1.deserializeBorsh)(exports.VAULT_SCHEMA, Vault, buffer);
};
exports.decodeVault = decodeVault;
const decodeSafetyDeposit = (buffer) => {
    return (0, borsh_1.deserializeBorsh)(exports.VAULT_SCHEMA, SafetyDepositBox, buffer);
};
...
async function initVault(allowFurtherShareCreation, fractionalMint, redeemTreasury, fractionalTreasury, vault, vaultAuthority, pricingLookupAddress, instructions) {
    const vaultProgramId = (0, ids_1.programIds)().vault;
    const data = Buffer.from((0, borsh_2.serialize)(exports.VAULT_SCHEMA, new InitVaultArgs({ allowFurtherShareCreation })));
    const keys = [
        {
...
async function addTokenToInactiveVault(amount, tokenMint, tokenAccount, tokenStoreAccount, vault, vaultAuthority, payer, transferAuthority, instructions) {
    ...
    const data = Buffer.from((0, borsh_2.serialize)(exports.VAULT_SCHEMA, value));
    const keys = [
        {
