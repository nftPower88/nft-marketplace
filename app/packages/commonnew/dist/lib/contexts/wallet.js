...
exports.WalletProvider = exports.WalletModalProvider = exports.WalletModal = exports.useWalletModal = exports.WalletModalContext = exports.WalletNotConnectedError = exports.SignerWalletAdapter = exports.useWallet = void 0;
const wallet_adapter_base_1 = require("@solana/wallet-adapter-base");
Object.defineProperty(exports, "SignerWalletAdapter", { enumerable: true, get: function () { return wallet_adapter_base_1.SignerWalletAdapter; } });
...
function useWallet() {
    return (0, wallet_adapter_react_1.useWallet)();
}
...
const WalletModal = () => {
    ...
    const close = (0, react_1.useCallback)(() => setVisible(false), [setVisible]);
...
const WalletProvider = ({ children }) => {
    const { env } = (0, connection_1.useConnectionConfig)();
    ...
    const wallets = (0, react_1.useMemo)(() => [
        ...
        (0, wallet_adapter_wallets_1.getSolletWallet)({ network }),
        (0, wallet_adapter_wallets_1.getSolletExtensionWallet)({ network }),
    ], []);
