...
const UseNativeAccount = () => {
    const connection = (0, contexts_1.useConnection)();
    const { publicKey } = (0, contexts_1.useWallet)();
...
const precacheUserTokenAccounts = async (connection, owner) => {
    ...
    const accounts = await connection.getTokenAccountsByOwner(owner, {
        programId: (0, ids_1.programIds)().token,
    });
...
function AccountsProvider({ children = null }) {
    ...
    const selectUserAccounts = (0, react_1.useCallback)(() => {
        return exports.cache
            ...
            .filter(a => a && a.info.owner.toBase58() === (publicKey === null || publicKey === void 0 ? void 0 : publicKey.toBase58()))
            .map(a => a);
    }, [publicKey]);
    (0, react_1.useEffect)(() => {
    ...
    (0, react_1.useEffect)(() => {
        if (!connection || !publicKey) {
            ...
            const tokenSubID = connection.onProgramAccountChange((0, ids_1.programIds)().token, info => {
